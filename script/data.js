"use strict";
// Lấy thông tin file tải lên lưu lại vào localStorage
var data;
...
importData.addEventListener("click", function () {
  if (data) {
    localStorage.setItem("petArr", JSON.stringify(data));
    fileSelector.value = "";
    data = "";
  } else {
...
// sư khi click Export Data
const exportData = document.getElementById("export-btn");
exportData.addEventListener("click", savePetData);
// ham export
...
// Phần code lấy trong bài hướng dẫn làm asm
/*
 * FileSaver.js
